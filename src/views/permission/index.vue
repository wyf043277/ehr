  ...
  <div class="dashboard-container">
    <div class="app-container">
      ...
      <el-dialog
        ...
        @close="dialogClose"
      >
        <permissionDialog ref="permissionDialog" :edit-data="editData" />
        ...
        <el-table border style="width: 100%" :data="permissionList" row-key="id">
          ...
          <el-table-column label="操作" width="280">
            <template slot-scope="scope">
              <el-button v-if="scope.row.type!==2" type="text" size="small" @click="addPermission(scope.row.id)">添加</el-button>
